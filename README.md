...
During testing it became clear that for users who were accessing my game through an iPhone or iPad of any model the button on the home acreen would not appear. After testing and researching I found that flex-basis was causing the issue, and seems to be a [known bug on their operating system which they reffer to as a 'feature'](https://stackoverflow.com/questions/37112218/css3-100vh-not-constant-in-mobile-browser). As such I changed all instances of flex-basis: 0 to flex-basis: auto and no longer had the issue.  
